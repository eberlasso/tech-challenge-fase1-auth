...
/**
 * Filter that intercepts every request to validate the JWT token and its roles.
 */
@Component
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (token != null) {
            ...
            if (login != null && !login.isEmpty()) {
                ...
                // Criamos a autoridade baseada na role salva no token (ex: ROLE_CLIENT ou ROLE_RESTAURANT_OWNER)
